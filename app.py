...
with tab_calendar:
    ...
    with col_lbl:
        st.markdown("<div style='display: flex; align-items: center; justify-content: flex-end; height: 38px; font-weight: 500; color: #7f8fa6; font-size: 0.95rem; margin-top: 0px;'>Buscar:</div>", unsafe_allow_html=True)
    with col_search:
